const id = "YOUR_CLIENT_ID1";
const sec = "YOUR_SECRET_ID1";
...
export function fetchPopularRepos(language) {
    const endpoint = `https://api.github.com/search/repositories?q=stars:%3E100+language:${language}&sort=star&order=desc&type=Repositories&&per_page=40`;
